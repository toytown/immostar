package com.immostar.controller;
...
import com.immostar.facades.RealStateSearch;
...
public class HomeController {
	...
	RealStateSearch realStateSearchFacede = new RealStateSearch();
	...
	public String displaySearchResults(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
